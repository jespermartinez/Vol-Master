...
/* Shifting Login to Register Page */       

            var go_to_register = document.querySelector(".go_to_register");
            var go_to_login = document.querySelector(".fas");
            var form_login = document.querySelector(".login"); 
            var form_register = document.querySelector(".register"); 

            go_to_register.onclick = function(){
